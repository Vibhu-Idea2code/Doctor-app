...
router.put("/update-doctor-profile",accessToken(),singleFileUpload("/doctorImg", "image"),doctorController.updateDocProfile);

         /* -------------------------- DELTE DOCTOR PROFILE DOCTOR ----------- */
router.delete("/delete-doc/:doctorId",  accessToken(), doctorController.deleteDoctor);
